...
function defineThemes(monaco: Monaco) {
  monaco.editor.defineTheme("complexitylab-dark", {
    ...
    rules: [
      ...
      { token: "string", foreground: "45eca6" },
    ...
    colors: {
      ...
      "editor.foreground": "#edf2fc",
      "editor.lineHighlightBackground": "#141e32",
      "editorLineNumber.foreground": "#3a4a5c",
      "editorLineNumber.activeForeground": "#8a9dbf",
      "editorCursor.foreground": "#21e08c",
      "editor.selectionBackground": "#1e3050",
      "editorIndentGuide.background1": "#131e30",
      "editorWidget.background": "#141e32",
    },
  });
